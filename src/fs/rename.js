...
const rename = async () => {
    const sourceFolder = path.join(getDirPath(import.meta.url),'files', 'wrongFilename.txt');
    const targetFolder = path.join(getDirPath(import.meta.url),'files', 'properFilename.md');
